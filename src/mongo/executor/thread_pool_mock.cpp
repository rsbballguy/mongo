...
void ThreadPoolMock::_consumeOneTask(stdx::unique_lock<Mutex>& lk) {
...
void ThreadPoolMock::_shutdown(stdx::unique_lock<Mutex>& lk) {
...
void ThreadPoolMock::_join(stdx::unique_lock<Mutex>& lk) {
    LOG(1) << "Joining pool";
