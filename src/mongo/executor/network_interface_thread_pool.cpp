 ...
 */
void NetworkInterfaceThreadPool::_consumeTasks(stdx::unique_lock<Mutex> lk) {
...
void NetworkInterfaceThreadPool::_consumeTasksInline(stdx::unique_lock<Mutex> lk) noexcept {
