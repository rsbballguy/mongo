...
public:
    ...
    bool operator==(synchronized_value const& rhs) const {
        ...
        stdx::lock_guard<Mutex> lk1(_mutex, stdx::adopt_lock);
        stdx::lock_guard<Mutex> lk2(rhs._mutex, stdx::adopt_lock);
    ...
    bool operator==(T const& rhs) const {
        stdx::lock_guard<Mutex> lock1(_mutex);
        return _value == rhs;
    }
...
bool operator==(const synchronized_value<T>& lhs, const T& rhs) {
    stdx::lock_guard<Mutex> lock(lhs._mutex);
...
bool operator==(const T& lhs, const synchronized_value<T>& rhs) {
    stdx::lock_guard<Mutex> lock(rhs._mutex);
...
bool operator==(const synchronized_value<T>& lhs, const synchronized_value<T>& rhs) {
    ...
    stdx::lock_guard<Mutex> lk1(lhs._mutex, stdx::adopt_lock);
    stdx::lock_guard<Mutex> lk2(rhs._mutex, stdx::adopt_lock);
